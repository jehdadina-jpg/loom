...
const buildPath: LocationBuilder = (pack, seed) => {
  ...
  return {
    ...
    objects: () => [
      ...
      flowerObj(172, 262, 1),
      flowerObj(340, 266, 3),
      flowerBedObj(150, 268, 4, 30),
      bloomingBushObj(392, 200, 1),
      rockObj(118, 270, 1),
...
const buildHome: LocationBuilder = (_pack, seed) => {
  ...
  return {
    ...
    objects: () => [
      ...
      flowerObj(182, 264, 1),
      flowerObj(348, 268, 3),
      flowerBedObj(200, 268, 2, 26),
      bloomingBushObj(60, 230, 2),
      fenceObj(4, 236, 2),
...
const buildCommunity: LocationBuilder = (_pack, seed) => {
  ...
  return {
    ...
    objects: () => [
      ...
      flowerObj(430, 266, 2),
      flowerBedObj(100, 268, 8, 26),
      bloomingBushObj(420, 210, 3),
    ],
  };
};
...
const buildGarden: LocationBuilder = (_pack, seed) => {
  ...
  return {
    ...
    objects: () => [
      ...
      flowerObj(206, 258, 1),
      flowerObj(344, 256, 3),
      flowerBedObj(150, 262, 10, 34),
      flowerBedObj(300, 260, 11, 34),
      bloomingBushObj(90, 220, 0),
